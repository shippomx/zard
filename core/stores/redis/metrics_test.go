...
func Test_newCollector(t *testing.T) {
	...
	val := `
		...
		redis_client_pool_conn_idle_current{client_type="cluster",gz_version="",key="test3"} 40
        redis_client_pool_conn_idle_current{client_type="node",gz_version="",key="test1"} 20
        redis_client_pool_conn_idle_current{client_type="node",gz_version="",key="test2"} 21
	 	# HELP redis_client_pool_conn_max Max number of connections in the pool
	 	# TYPE redis_client_pool_conn_max counter
		redis_client_pool_conn_max{client_type="cluster",gz_version="",key="test3"} 5
        redis_client_pool_conn_max{client_type="node",gz_version="",key="test1"} 10
    	redis_client_pool_conn_max{client_type="node",gz_version="",key="test2"} 11
		...
		redis_client_pool_conn_stale_total{client_type="cluster",gz_version="",key="test3"} 2
        redis_client_pool_conn_stale_total{client_type="node",gz_version="",key="test1"} 1
        redis_client_pool_conn_stale_total{client_type="node",gz_version="",key="test2"} 2
		...
		redis_client_pool_conn_total_current{client_type="cluster",gz_version="",key="test3"} 200
        redis_client_pool_conn_total_current{client_type="node",gz_version="",key="test1"} 100
        redis_client_pool_conn_total_current{client_type="node",gz_version="",key="test2"} 101
		...
		redis_client_pool_hit_total{client_type="cluster",gz_version="",key="test3"} 20000
        redis_client_pool_hit_total{client_type="node",gz_version="",key="test1"} 10000
        redis_client_pool_hit_total{client_type="node",gz_version="",key="test2"} 10001
		...
		redis_client_pool_miss_total{client_type="cluster",gz_version="",key="test3"} 20
        redis_client_pool_miss_total{client_type="node",gz_version="",key="test1"} 10
        redis_client_pool_miss_total{client_type="node",gz_version="",key="test2"} 11
		...
		redis_client_pool_timeout_total{client_type="cluster",gz_version="",key="test3"} 10
        redis_client_pool_timeout_total{client_type="node",gz_version="",key="test1"} 5
        redis_client_pool_timeout_total{client_type="node",gz_version="",key="test2"} 6
`
