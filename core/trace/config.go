...
type Config struct {
	...
	// OtlpGrpcSecure represents the scheme to use for OTLP GRPC transport.
	OtlpGrpcSecure bool `json:",optional"` //nolint:staticcheck,tagliatelle
	// OtlpGrpcTlsSkipVerify represents the scheme to accepts any certificate
	// presented by the server and any host name in that certificate.
	OtlpGrpcTLSSkipVerify bool `json:",optional"` //nolint:staticcheck,tagliatelle
}
