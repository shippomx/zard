...
* 带缓存模式
  * ddl
    ...
    OPTIONS:
       ...
       --style value          the file naming format, see [https://github.com/shippomx/zard/tree/master/tools/goctl/config/readme.md]
...
| decimal        | decimal.Decimal(github.com/shopspring/decimal) | decimal.NullDecimal(github.com/shopspring/decimal) |
