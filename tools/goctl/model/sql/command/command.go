...
import (
	...
	"github.com/shippomx/zard/core/collection"
	"github.com/shippomx/zard/core/logx"
	"github.com/shippomx/zard/core/stores/postgres"
	"github.com/shippomx/zard/core/stores/sqlx"
	"github.com/shippomx/zard/tools/goctl/config"
	"github.com/shippomx/zard/tools/goctl/model/sql/command/migrationnotes"
	"github.com/shippomx/zard/tools/goctl/model/sql/gen"
	"github.com/shippomx/zard/tools/goctl/model/sql/model"
	"github.com/shippomx/zard/tools/goctl/model/sql/template"
	"github.com/shippomx/zard/tools/goctl/model/sql/util"
	file "github.com/shippomx/zard/tools/goctl/util"
...
var (
	...
	// VarStringTemplate represents local sql template. default will be set gorm-zero
...
func MysqlDDL(_ *cobra.Command, _ []string) error {
	...
	logx.Must(os.Setenv(template.ENV_GOCTL_SQL_TEMPLATE, VarStringTemplate))
	template.Init()
	if len(remote) > 0 {
