...
import (
	...
	"github.com/shippomx/zard/tools/goctl/model/mongo"
	"github.com/shippomx/zard/tools/goctl/model/sql/command"
)
...
func init() {
	...
	ddlCmdFlags.StringVar(&command.VarStringTemplate, "template")
	...
	datasourceCmdFlags.StringVar(&command.VarStringTemplate, "template")
	...
	pgDatasourceCmdFlags.StringVar(&command.VarStringTemplate, "template")
