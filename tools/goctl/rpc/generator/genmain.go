...
func (g *Generator) GenMain(ctx DirContext, proto parser.Proto, cfg *conf.Config,
	...
	if c.IsGrpcGateway {
		imports = append(imports, fmt.Sprintf(`"%v"`, "github.com/shippomx/zard/gateway/v2"))
		imports = append(imports, fmt.Sprintf(`"%v"`, "github.com/grpc-ecosystem/grpc-gateway/v2/runtime"))
	}
