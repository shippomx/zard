...
import (
	...
	"github.com/shippomx/zard/tools/goctl/rpc/cli"
...
func init() {
	...
	newCmdFlags.BoolVarWithDefaultValue(&cli.VarBoolProtocValidate, "validate", false)
	newCmdFlags.BoolVarWithDefaultValue(&cli.VarBoolGrpcGateway, "grpc-gateway", false)

	protocCmdFlags.BoolVarP(&cli.VarBoolMultiple, "multiple", "m")
	protocCmdFlags.StringSliceVar(&cli.VarStringSliceGoOut, "go_out")
	protocCmdFlags.StringSliceVar(&cli.VarStringSlicevalidateOut, "validate_out")
	protocCmdFlags.StringSliceVar(&cli.VarStringSliceGrpcGatewayOut, "grpc-gateway_out")
	...
	protocCmdFlags.BoolVarWithDefaultValue(&cli.VarBoolClientOnly, "client-only", false)
	...
	templateCmdFlags.BoolVarWithDefaultValue(&cli.VarBoolProtocValidate, "validate", false)
	templateCmdFlags.BoolVarWithDefaultValue(&cli.VarBoolGrpcGateway, "grpc-gateway", false)
