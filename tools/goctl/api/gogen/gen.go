...
import (
	...
	apiformat "github.com/shippomx/zard/tools/goctl/api/format"
	"github.com/shippomx/zard/tools/goctl/api/parser"
	apiutil "github.com/shippomx/zard/tools/goctl/api/util"
	"github.com/shippomx/zard/tools/goctl/config"
	"github.com/shippomx/zard/tools/goctl/pkg/golang"
...
func DoGenProject(apiFile, dir, style string) error {
	...
	logx.Must(genLint(dir, rootPkg))
	logx.Must(genMakefile(dir))
