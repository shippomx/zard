...
import (
	"github.com/shippomx/zard/tools/goctl/api/apigen"
	"github.com/shippomx/zard/tools/goctl/api/dartgen"
	"github.com/shippomx/zard/tools/goctl/api/docgen"
	"github.com/shippomx/zard/tools/goctl/api/format"
	"github.com/shippomx/zard/tools/goctl/api/gogen"
	"github.com/shippomx/zard/tools/goctl/api/javagen"
	"github.com/shippomx/zard/tools/goctl/api/ktgen"
	"github.com/shippomx/zard/tools/goctl/api/new"
	"github.com/shippomx/zard/tools/goctl/api/tsgen"
	"github.com/shippomx/zard/tools/goctl/api/validate"
	"github.com/shippomx/zard/tools/goctl/config"
	"github.com/shippomx/zard/tools/goctl/internal/cobrax"
	"github.com/shippomx/zard/tools/goctl/plugin"
...
func init() {
	...
	newCmdFlags.StringVarWithDefaultValue(&new.VarHandlerStyle, "handlerStyle", config.CamelHandlerFormat)
