...
import (
	...
	"github.com/shippomx/zard/tools/goctl/api"
	"github.com/shippomx/zard/tools/goctl/bug"
	"github.com/shippomx/zard/tools/goctl/docker"
	"github.com/shippomx/zard/tools/goctl/env"
	"github.com/shippomx/zard/tools/goctl/gateway"
	"github.com/shippomx/zard/tools/goctl/internal/cobrax"
	"github.com/shippomx/zard/tools/goctl/internal/version"
	"github.com/shippomx/zard/tools/goctl/kube"
	"github.com/shippomx/zard/tools/goctl/lint"
	"github.com/shippomx/zard/tools/goctl/migrate"
	"github.com/shippomx/zard/tools/goctl/model"
	"github.com/shippomx/zard/tools/goctl/quickstart"
	"github.com/shippomx/zard/tools/goctl/rpc"
	"github.com/shippomx/zard/tools/goctl/tpl"
	"github.com/shippomx/zard/tools/goctl/upgrade"
	"github.com/shippomx/zard/tools/goctl/xxljob"
...
func init() {
	...
	rootCmd.AddCommand(api.Cmd, bug.Cmd, docker.Cmd, kube.Cmd, env.Cmd, gateway.Cmd, model.Cmd, lint.Cmd, xxljob.Cmd)
